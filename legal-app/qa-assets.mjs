...
for(const p of['./index.html','./app.css?v=11','./quiz.css?v=11','./solve2.css?v=11','./skill.css?v=13','./app.js?v=13','./manifest.webmanifest','./js/cloud-gate.js?v=13','./js/cloud.js','./js/learning-evidence.js','./js/skill-map.js','./js/skill-cache.js','./js/analytics.js'])if(!sw.includes(`'${p}'`))bad(`shell missing ${p}`);
