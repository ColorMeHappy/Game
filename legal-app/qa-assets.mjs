...
for(const p of['./index.html','./app.css?v=11','./quiz.css?v=11','./solve2.css?v=11','./skill.css?v=14','./a11y.css?v=1','./app.js?v=13','./manifest.webmanifest','./js/a11y.js?v=1','./js/cloud-gate.js?v=13','./js/cloud.js','./js/learning-evidence.js','./js/confidence.js','./js/skill-map.js','./js/skill-cache.js','./js/analytics.js'])if(!sw.includes(`'${p}'`))bad(`shell missing ${p}`);
for(const old of['./app.js?v=11','./app.js?v=12','./js/cloud.js?v=11','./js/cloud.js?v=12','./skill.css?v=13','styles/base.css','styles/components.css','styles/pages.css','styles/content.css'])if(sw.includes(`'${old}'`))bad(`stale precache ${old}`);
